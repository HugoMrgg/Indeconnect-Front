...
export const BrandFiltersPanel: React.FC<BrandFiltersPanelProps> = ({
    ...
    const sortBy = apiFilters.sortBy ?? "";
    const distance = apiFilters.maxDistanceKm;
    const minRating = apiFilters.userRatingMin;
    const priceRange = apiFilters.priceRange ?? "";
    const minEthicsProduction = apiFilters.minEthicsProduction;
    const minEthicsTransport = apiFilters.minEthicsTransport;
    const selectedEthicTags = apiFilters.ethicTags ?? [];
    const hasGPSPosition = !!position;
                ...
                `}
                            ...
                            <div>
                                ...
                                {currentCity && (
                                    <p className="text-xs text-gray-500 mt-2 flex items-center gap-1">
                                        ...
                                        Position simulée à {currentCity}
                                    </p>
                                )}
                            </div>
                        )}
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={e => handleEthicsProduction(Number(e.target.value) || undefined)}
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={e => handleEthicsTransport(Number(e.target.value) || undefined)}
                            className="w-full accent-green-500"
                        />
                        <div className="flex justify-between text-xs text-gray-500 mt-1">
                            <span>0</span>
                    ...
                    <div>
                        ...
                        <StarRating
                            rating={minRating ?? 0}
                            onRatingChange={(rating) => handleUserRating(rating > 0 ? rating : undefined)}
                        />
                    </div>
                        ...
                        <div className="flex flex-wrap gap-2">
                            {[
                                ...
                                <button
                                    key={option.value}
                                    type="button"
                                    onClick={() => handlePriceRange(option.value)}
                                    className={`
